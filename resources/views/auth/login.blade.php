                    ...
                    <div class="card-body p-4">
                        ...
                        <form action="{{ route('login') }}" method="POST">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input name="email" class="form-control @error('email') is-invalid @enderror" type="email" id="emailaddress" placeholder="Enter your email" value="{{ old('email') }}">
                                @error('email')
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input name="password" class="form-control @error('password') is-invalid @enderror" type="password" id="password" placeholder="Enter your password" value="{{ old('password') }}">
                                @error('password')
                                <span class="invalid-feedback text-danger" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="form-group mb-3">
                                <div class="">
                                    <input {{ old('remember') ? 'checked' : '' }} name="remember" class="form-check-input" type="checkbox" id="checkbox-signin" checked>
